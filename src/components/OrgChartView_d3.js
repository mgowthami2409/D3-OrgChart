  ...
  function OrgChartView_d3({
    ...
    const renderAndFit = (chart) => {
      chart.render();        // correct
      setTimeout(() => {
        try { chart.fit(); } catch {}
        recolorAndBadges();
        if (typeof removeCountBubbles === "function") removeCountBubbles();
      }, 50);
    };
